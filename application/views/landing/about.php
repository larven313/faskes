<body class="about-us bg-gray-200">
    ...
    <header class="bg-gradient-dark">
        <div class="page-header min-vh-75" style="background-image: url('https://main.mobile.doss.co.id/storage/uploads/2020/04/oib0SOPmnFOHbU9atn9LKSHpa96CrP1PI0vU0EJV.webp');">
            <span class="mask bg-gradient-dark opacity-6"></span>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center mx-auto my-auto">
                        <h1 class="text-white">Melayani Sepenuh Hati</h1>
                        <p class="lead mb-4 text-white opacity-8">Kami adalah kelompok Andromeda Dev dari STT Terpadu Nurul Fikri, sebuah kelompok mahasiswa STT-NF yang menggeluti bidang software develop </p>
                        <button type="submit" class="btn bg-white text-dark"> <a href="<?= base_url('user/registration') ?>"> Create Account</a></button>
                                ...
                                <div class="col-lg-4 col-md-6 col-12 mt-n5">
                                    <a href="javascript:;">
                                        <div class="p-3 pe-md-0">
                                            <img class="w-100 border-radius-md shadow-lg" src="<?= base_url('assets/template/dist/img/team-5.jpg') ?>" alt="image">
                                        </div>
                                    </a>
                                </div>
                        ...
                        <div class="card card-profile mt-lg-4 mt-5">
                            <div class="row">
                                <div class="col-lg-4 col-md-6 col-12 mt-n5">
                                    <a href="javascript:;">
                                        <div class="p-3 pe-md-0">
                                            <img class="w-100 border-radius-md shadow-lg" src="<?= base_url('assets/template/dist/img/bruce-mars.jpg') ?>" alt="image">
                                        </div>
                                    </a>
                                </div>
                                <div class="col-lg-8 col-md-6 col-12 my-auto">
                                    <div class="card-body ps-lg-0">
                                        <h5 class="mb-0">Sukma Hidayatullah</h5>
                                        <h6 class="text-info">Fullstack Progammer</h6>
                                        <p class="mb-0">Artist is a term applied to a person who engages in an activity deemed to be an art.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card card-profile mt-4 z-index-2">
                            <div class="row">
                                <div class="col-lg-4 col-md-6 col-12 mt-n5">
                                    <a href="javascript:;">
                                        <div class="p-3 pe-md-0">
                                            <img class="w-100 border-radius-md shadow-lg" src="<?= base_url('assets/template/dist/img/ivana-squares.jpg') ?>" alt="image">
                                        </div>
                                    </a>
                                </div>
                                <div class="col-lg-8 col-md-6 col-12 my-auto">
                                    <div class="card-body ps-lg-0">
                                        <h5 class="mb-0">Muhammad Salsabil</h5>
                                        <h6 class="text-info">Backend Programmer</h6>
                                        <p class="mb-0">Artist is a term applied to a person who engages in an activity deemed to be an art.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card card-profile mt-lg-4 mt-5 z-index-2">
                            <div class="row">
                                <div class="col-lg-4 col-md-6 col-12 mt-n5">
                                    <a href="javascript:;">
                                        <div class="p-3 pe-md-0">
                                            <img class="w-100 border-radius-md shadow-lg" src="<?= base_url('assets/template/dist/img/ivana-square.jpg') ?>" alt="image">
                                        </div>
                                    </a>
                                </div>
                                <div class="col-lg-8 col-md-6 col-12 my-auto">
                                    <div class="card-body ps-lg-0">
                                        <h5 class="mb-0">Muhammad Gilang al-wafi</h5>
            ...
            <div class="container">
                <div class="row mb-7">
                    <div class="col-lg-2 col-md-4 col-6 mb-4">
                        <img class="w-100 opacity-7" src="<?= base_url('assets/template/dist/img/logos/gray-logos/logo-coinbase.svg') ?>" alt="logo">
                    </div>
                    <div class="col-lg-2 col-md-4 col-6 mb-4">
                        <img class="w-100 opacity-7" src="<?= base_url('assets/template/dist/img/logos/gray-logos/logo-nasa.svg') ?>" alt="logo">
                    </div>
                    <div class="col-lg-2 col-md-4 col-6 mb-4">
                        <img class="w-100 opacity-7" src="<?= base_url('assets/template/dist/img/logos/gray-logos/logo-netflix.svg') ?>" alt="logo">
                    </div>
                    <div class="col-lg-2 col-md-4 col-6 mb-4">
                        <img class="w-100 opacity-7" src="<?= base_url('assets/template/dist/img/logos/gray-logos/logo-pinterest.svg') ?>" alt="logo">
                    </div>
                    <div class="col-lg-2 col-md-4 col-6 mb-4">
                        <img class="w-100 opacity-7" src="<?= base_url('assets/template/dist/img/logos/gray-logos/logo-spotify.svg') ?>" alt="logo">
                    </div>
                    <div class="col-lg-2 col-md-4 col-6 mb-4">
                        <img class="w-100 opacity-7" src="<?= base_url('assets/template/dist/img/logos/gray-logos/logo-vodafone.svg') ?>" alt="logo">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 ms-auto">
                        <div class="position-relative">
                            <img class="max-width-50 w-100 position-relative z-index-2" src="<?= base_url('assets/template/dist/img/macbook.png') ?>" alt="image">
                        </div>
                    </div>
                </div>
            </div>
